...
{
	private static CmdFactionsHome i = new CmdFactionsHome();
	public static CmdFactionsHome get() { return i; }
	// -------------------------------------------- //
	// CONSTRUCT
	// -------------------------------------------- //
	...
	public void perform() throws MassiveException
	{
		...
		if (home == null)
		{
			...
			if (MPerm.getPermSethome().has(msender, faction, false))
			{
				...
				msender.message(CmdFactionsSethome.get().getTemplate());
			}
		...
		try
		{
			...
			EngineEssentials.get().teleport(me, destination, sender);
		}
		catch (Exception e)
		{
