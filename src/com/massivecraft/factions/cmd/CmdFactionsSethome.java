...
{
	private static CmdFactionsSethome i = new CmdFactionsSethome();
	public static CmdFactionsSethome get() { return i; }
	// -------------------------------------------- //
	// CONSTRUCT
	// -------------------------------------------- //
	...
	public void perform() throws MassiveException
	{
		...
		faction.sendMessage(CmdFactionsHome.get().getTemplate());
