...
public class CmdFactionsPtop extends FactionsCommand {
    ...
    public void perform() throws MassiveException {
        ...
        final Pager<Mson> pager = new Pager<>(this, Txt.parse(LangConf.get().ptopPagerName), page, topData, (Msonifier<Mson>) (item, index) -> mson(Txt.parse("<a>%s. ", (index + 1))).add(topData.get(index)));
