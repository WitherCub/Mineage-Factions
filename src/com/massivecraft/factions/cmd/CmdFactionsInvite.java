...
{
	private static CmdFactionsInvite i = new CmdFactionsInvite();
	public static CmdFactionsInvite get() { return i; }
	// -------------------------------------------- //
	// CONSTRUCT
	// -------------------------------------------- //
	...
	public void perform() throws MassiveException
	{
		...
		for (MPlayer mplayer : mplayers)
		{
			...
			{
				// Mson
				String command = CmdFactionsDeinvite.get().getCommandLine(mplayer.getName());
