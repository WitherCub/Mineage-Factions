...
{
	private static CmdFactionsDeinvite i = new CmdFactionsDeinvite();
	public static CmdFactionsDeinvite get() { return i; }
	// -------------------------------------------- //
	// CONSTRUCT
	// -------------------------------------------- //
	...
	public void perform() throws MassiveException
	{
		...
		for (MPlayer mPlayer : mplayers)
		{
			...
			{
				msender.msg("<b>%s is invited as an alt. Please use /f alts revoke to revoke this invitation.", mPlayer.getName());
		...
		for (MPlayer mplayer : mplayers)
		{
			...
			{
				// Mson
				String command = CmdFactionsInvite.get().getCommandLine(mplayer.getName());
				String tooltip = Txt.parse("Click to <c>%s<i>.", command);
