...
public class EventFactionsMembershipChange extends EventFactionsAbstractSender
{
	...
	private final boolean altJoin;
	public boolean isAltJoin() { return this.altJoin; }

	// -------------------------------------------- //
	// CONSTRUCT
	// -------------------------------------------- //
	
	public EventFactionsMembershipChange(CommandSender sender, MPlayer mplayer, Faction newFaction, MembershipChangeReason reason, boolean altJoin)
	{
		super(sender);
		this.mplayer = mplayer;
		this.newFaction = newFaction;
		this.reason = reason;
		this.altJoin = altJoin;
	}
